...
public interface AlertsApi {
    ...
    /** 逃生口：脚本要传额外 fingerprint/labels/ttl/evidence 时直接 emit AlertSpec。 */
    ...
    default void warning(final Map<String, Object> annotations) {
        emit(new AlertSpec(null, Severity.WARNING, null, annotations, null, false, null));
    }

    default void info(final Map<String, Object> annotations) {
        emit(new AlertSpec(null, Severity.INFO, null, annotations, null, false, null));
    }
}
